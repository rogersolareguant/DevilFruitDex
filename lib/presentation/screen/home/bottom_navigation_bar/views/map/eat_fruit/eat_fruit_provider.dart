...
import 'package:devilfruitdex/presentation/screen/home/bottom_navigation_bar/views/map/eat_fruit/eat_fruit_loaded.dart';
...
class EatFruitProvider extends StatelessWidget {
  final String id;

  const EatFruitProvider({super.key, required this.id});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => DevilFruitCubit(
          ...
          uid: currentUser.uid)
        ..getAllDevilFruits(),
      child: EatFruit(id: id),
    );
  }
}

class EatFruit extends StatelessWidget {
  final String id;
